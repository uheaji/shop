...
// list.jsp에서 넘어온 num 값과 nowPage값을 받습니다.
...
<body bgcolor="#FFFFCC">
	...
	<table align="center" width="70%" border=0 cellspacing="3"
		...
		<tr>
			<td colspan="2">
				<table border="0" cellpadding="3" cellspacing="0" widht=100%>
					<tr>
				...
				[ <a href = "javascript:list()">리스트</a> |
					...
					<a href = "reply.jsp?nowPage=<%=nowPage%>&num=<%=num%>">삭 제</a> | <br/>
					</td>
					</tr>
	</table>
	...
	<form name = "lisfFrm"  method = "post"  action = "list.jsp">
