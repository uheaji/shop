				...
				<tr>
					<td align="center">
						<table border="0">
							...
							<tr>
								<td width="20%">제 목</td>
								<td width="80%"><input name="subject" size="50"
									value="답변 : <%=subject%>" maxlength="50"></td>
							</tr>
							<tr>
								<td>내 용</td>
								<td><textarea name="content" rows="12" cols="50"><%=content%>=========답변 글을 쓰세요.==========</textarea></td>
							</tr>
							<tr>
								<td width="20%">성 명</td>
								<td width="80%"><input name="name" size="30" maxlength="20"></td>
							...
							<tr>
								<td colspan="2"><input type="submit" value="답변등록">
									...
									value="뒤로" onclick="history.back()"></td>
							</tr>
						</table>
						</td>
						</tr>
						...
						<input type = "hidden"  name = "ip"  value = "<%=bean.getPos() %>">
